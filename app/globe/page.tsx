                      ...
                      <div className='space-y-2 max-h-[500px] overflow-y-auto pr-2'>
                        {Array.from(visitedCountries)
                          ...
                          .map((country, key) => (
                            <div
                              key={key}
                              className='flex items-center gap-2 p-3 rounded-lg bg-gray-50 hover:bg-gray-100 transition-colors border border-gray-100'
                            >
                              <BiMapPin className='h-4 w-4 text-red-400' />
                              <span>{country}</span>
                            </div>
                          ))}
                      </div>
